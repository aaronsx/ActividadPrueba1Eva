...
export const ASUGNATURAS: Asignatura[] = [
  ...
  {asignatura:"Despliegues de aplicaciones web", siglasAsignatura:"DAW",profesores:"JCA"},
  {asignatura:"Desarrollo web en entorno cliente", siglasAsignatura:"DWC",profesores:"JGF"},
];